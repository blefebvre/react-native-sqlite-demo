...
export class DatabaseInitialization {
    ...
    private createTables(transaction: SQLite.Transaction) {
        // List table
        transaction.executeSql("CREATE TABLE IF NOT EXISTS List( " +
        ...
        // ListItem table
        transaction.executeSql("CREATE TABLE IF NOT EXISTS ListItem( " +
    ...
    private getDatabaseVersion(database: SQLite.SQLiteDatabase): Promise<number> {
        ...
        return database.executeSql(
            ...
            console.error(`Error reading versions table. Returning 0. Details: ${error}`);
            return 0;
        });
    }
